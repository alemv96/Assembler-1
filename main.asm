...
.data
	...
	ingMemCache BYTE "Ingrese tamaño de la memoria Cache", 0dh, 0ah  ,"1. 32B", 0dh, 0ah , "2. 64B ",  0dh, 0ah , "3. 128B " ,  0dh, 0ah , "4. 256B", 0dh, 0ah , "5. 512B", 0dh, 0ah ,"6. 1KB ",0dh, 0ah , 0
...
main proc 		
	inicio:			
		...
		jb error 
		cmp eax , 4  ; ahora si el numero es mayor que 3 mando un error
		ja error
		cmp al, 3
